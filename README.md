...
(<b>A new and improved svmu is coming soon. BLAST etc. will no longer be required in the new version</b>)
...
Note: svmu is not a read mapping based copy number variation detection tool. It calls duplicates and TEs from alignments between two genome assemblies. If you publish results obtained with this pipeline, please cite the <a href="http://biorxiv.org/content/early/2017/03/08/114967"> manuscript</a> that describes SVMU.
